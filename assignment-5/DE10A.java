// DE10A.java CS5125/6025 Cheng 2024
// performs Burrows-Wheeler transform to reduce entropy
// Usage: java DE10A < original > transformed
...
class DE10A{
  ...
  int[] s = new int[BLOCKSIZE * 2];  // block repeated twice for sorting
 ...
 void readBlock(){
   ...
   for (int i = 0; i < length; i++)
       s[i] = s[length + i] = Byte.toUnsignedInt(buffer[i]);
 }
